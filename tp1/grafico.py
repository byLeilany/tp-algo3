...
df = pd.read_csv("runtimeordenados.csv")
df2 = pd.read_csv("runtime.csv")
...
ax.plot(df['log_cota'],df['log_time'],color='red', label='sorted')
ax.plot(df2['log_cota'],df2['log_time'],color='blue', label='unsorted')
